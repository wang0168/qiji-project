...
public class UserManagerActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(new BarBean().setMsg("用户管理").setIsRemoveBack(true));
    ...
    protected void doMenu(MenuItemBean menuItemBean) {
        ...
        startActivity(new Intent(this, UserManagerPersonalActivity.class));
    }
    ...
    protected void startRequestData(int index) {
        ...
        switch (index) {
            case bill:
                ...
                getDataWithPost(bill, Host.hostUrl + "api.php?m=Api&c=User&a=bill", params);
                break;
            case getData:
                params = new ArrayMap<>();
                params.put("company_id", userInfoBean.getCompany_id());
                params.put("token", userInfoBean.getToken());
                params.put("page", "1");
                getDataWithPost(getData, Host.hostUrl + "api.php?m=Api&c=User&a=userlist", params);
                break;
            case loadMore:
                params = new ArrayMap<>();
                params.put("company_id", userInfoBean.getCompany_id());
                ...
                getDataWithPost(loadMore, Host.hostUrl + "api.php?m=Api&c=User&a=userlist", params);
                break;
