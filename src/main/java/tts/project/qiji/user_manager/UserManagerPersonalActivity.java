...
import tts.project.qiji.adapter.UserManagerPersonalAdapter;
...
public class UserManagerPersonalActivity extends BaseActivity implements OnClickListener {
...
//        adapter(userManagerDataBean.getSign());
    ...
    private void adapter(List<UserManagerDataBean.SignBean> sign) {
        ...
        mlist.setAdapter(new UserManagerPersonalAdapter(this, sign));
    }
    ...
    protected void startRequestData(int index) {
        ...
        switch (index) {
            case getData:
                ...
                getDataWithPost(getData, Host.hostUrl + "api.php?m=Api&c=User&a=user_center", params);
                break;
        }
    }
